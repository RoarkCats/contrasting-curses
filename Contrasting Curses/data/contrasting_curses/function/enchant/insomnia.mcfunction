...
execute store result score #insomnia_count contrasting_curses if items entity @s armor.* *[minecraft:enchantments={levels:{"contrasting_curses:insomnia_curse":1}}]
execute if score #insomnia_count contrasting_curses matches ..1 unless predicate {condition:"random_chance", chance: 0.3} run return 0
execute if score #insomnia_count contrasting_curses matches 2 unless predicate {condition:"random_chance", chance: 0.5} run return 0
execute if score #insomnia_count contrasting_curses matches 3 unless predicate {condition:"random_chance", chance: 0.7} run return 0
execute if score #insomnia_count contrasting_curses matches 4.. unless predicate {condition:"random_chance", chance: 0.9} run return 0
